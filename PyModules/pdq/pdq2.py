...
import select #part of "hack" to catch some python shit errors
import errno #part of "hack" to catch some python shit errors
...
class Pdq2:
    ...
    #begin hack part of "hack" to catch some python shit errors

    # writing to device may cause an "error: (4, 'Interrupted system call')"
    # the following function catches this and retrys, this will work.
    # cf :
    # http://www.programcreek.com/python/example/992/select.error (Example 10)
    # https://sourceforge.net/p/pyserial/patches/29/
    # http://bugs.python.org/issue12268
    def _eintr_retry(self, func, *args): 
    ...
    def write_mem(self, channel, data, start_addr=0):
        self._eintr_retry(self._write_mem, [channel, data, start_addr])


    def _write_mem(self,args):  #originial write_mem function
        [channel, data, start_addr] = args
